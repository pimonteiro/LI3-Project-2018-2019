...
struct question {
    MyDate start; //Obviamente pertence a pergunta
    MyDate end;
...
QUESTION create_question(size_t my_id, char * my_title, char* my_tags, size_t my_owner_id,  MyDate my_start, ssize_t my_score, size_t my_n_answer){
    ...
    p->start = my_start;
    p->end   = create_date(0, 0, 0,0,0,0,0); // HERULUME
